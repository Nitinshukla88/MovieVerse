...
const VideoInfo = ( { movie }) => {
  ...
  return (
    <div className='absolute py-40 text-white bg-gradient-to-r from-black top-0 left-0 w-screen aspect-video'>
      ...
      <div className='px-28'>
        <button className='px-6 py-3 m-4 text-black bg-white rounded-md hover:bg-opacity-80'>Play▶️</button>
        <button className='bg-gray-200 px-4 py-3 text-white rounded-md bg-opacity-20'>More info</button>
      </div>
    </div>
  )
}
